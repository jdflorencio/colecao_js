...
var configLinha = function(val, objHash, objTelefone,ultimo_movimento_aceito,build)
	{
		...
		for(var i =0; tamObj>i ; i++)
			{
				...
				configLinha(val, obj.clientes[i].sngpc_registro[0].hash, obj.clientes[i].telefones,obj.clientes[i].ultimo_dia_aceito,obj.clientes[i].build);				
			}					
